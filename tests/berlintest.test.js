...
it('Identify the seconds, displaying the One-Second Panel on or off', () => {
    ...
    expect(oneSecPanel('02:12:04')).toBe("Y\n");
    expect(oneSecPanel('02:12:23')).toBe("O\n");
    expect(oneSecPanel('02:12:24')).toBe("Y\n");
    expect(oneSecPanel('02:12:00')).toBe("Y\n");
    expect(oneSecPanel('02:12:24')).toBe("Y\n");
    expect(oneSecPanel('02:12:29')).toBe("O\n");
    expect(oneSecPanel('02:12:10')).toBe("Y\n");
});
...
it('should accept the correct 24h formatted input, and display complete clock', () => {
    ...
    expect(berlinClock('22:46:29')).toBe("O\nRRRR\nRROO\nYYRYYRYYROO\nYOOO");
    expect(berlinClock('23:52:35')).toBe("O\nRRRR\nRRRO\nYYRYYRYYRYO\nYYOO");
    expect(berlinClock('23:52:04')).toBe("Y\nRRRR\nRRRO\nYYRYYRYYRYO\nYYOO");
    expect(berlinClock('23:52:36')).toBe("Y\nRRRR\nRRRO\nYYRYYRYYRYO\nYYOO");
    expect(berlinClock('23:52:40')).toBe("Y\nRRRR\nRRRO\nYYRYYRYYRYO\nYYOO");
    expect(berlinClock('23:52:00')).toBe("Y\nRRRR\nRRRO\nYYRYYRYYRYO\nYYOO");
});
